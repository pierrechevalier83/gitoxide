 ...
 * **Uncategorized**
    ...
    - Merge branch 'gix-glob-fix' ([`c1e4c62`](https://github.com/Byron/gitoxide/commit/c1e4c629c32f136d1bc6159d47c0a9cda1fffd19))
    - Add recursion depth limit to avoid runaway runtimes or stackoverflows. ([`16cab84`](https://github.com/Byron/gitoxide/commit/16cab8428ac40fb027e8d3770c571eabdbe46d13))
    - Merge branch 'gix-glob-recursion' ([`3c65ea3`](https://github.com/Byron/gitoxide/commit/3c65ea3bffc38e57c4101f85bc348fe0ffe80d9d))
    - Adjust logic to properly deal with match groups to prevent endless loops. ([`ac57855`](https://github.com/Byron/gitoxide/commit/ac578554a31670428117b4dd67ada51afd1914a5))
