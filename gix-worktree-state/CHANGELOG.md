 ...
 * **Uncategorized**
    ...
    - Fix formatting with `cargo fmt` ([`f964cb9`](https://github.com/Byron/gitoxide/commit/f964cb904b38d8fa9a49b337aa5cd74dc2a27fc4))
    - Consolidate the 3 dangling symlink test functions ([`87422ab`](https://github.com/Byron/gitoxide/commit/87422ab34922131e3243d5d7db7910a3f68978a4))
    - Add generated archives for new tests ([`55c635a`](https://github.com/Byron/gitoxide/commit/55c635a6dd692d6765d3a8e0e6f9ed5b0fbcf9c7))
    - Test that symlinks to directories are usable ([`fbc51df`](https://github.com/Byron/gitoxide/commit/fbc51df5fea4e64e2c108518b4a6602b473c7b0f))
    - Test symlinks to invalid and reserved Windows targets ([`fb1e614`](https://github.com/Byron/gitoxide/commit/fb1e614ebb907012e21f69c176710ee117bdbae9))
